...
import {UISudoku} from "./sudoku/UI"
import type {SudokuValues} from "./sudoku/SudokuTypes"
import {SudokuProblem} from "./sudoku/SudokuProblem"
import {Solver, Affectation} from "./services/CSP"
...
export class App {
  ...
  private constructor(
    ...
    private readonly _elements: AppElements,
  ) {}
  ...
  static create(props: AppProps): App | null {
    ...
    const ui = UISudoku.get(elements.canvas)
    if (!ui) {
      return null
    }
